...
def main():
    ...
    parser = argparse.ArgumentParser(prog="audiogen", epilog= '\n'.join([
	"  -lt LT LT LT, --lt LT LT LT",
	"                        left top (freq, onsteps, allsteps)",
	"  -ld LD LD LD, --ld LD LD LD",
	"                        left down (freq, onsteps, allsteps)",
	"  -rt RT RT RT, --rt RT RT RT",
	"                        right top (freq, onsteps, allsteps)",
	"  -rd RD RD RD, --rd RD RD RD",
	"                        left down (freq, onsteps, allsteps)",
	"  -b {16}, --bits {16}  Number of bits in each sample",
	"  -s SECS, --secs SECS  Duration of the wave in seconds.(default=10)",
	"  -r RATE, --rate RATE  Sample rate in Hz",
	"  -a AMPLITUDE, --amplitude AMPLITUDE",
	"                        Amplitude of the wave on a scale of 0.0-1.0."]))

    parser.add_argument('-lt', '--lt', help="left top (freq, onsteps, allsteps)", 
			nargs=3, default=(1000, 3, 5), type=int)
    parser.add_argument('-ld', '--ld', help="left down (freq, onsteps, allsteps)", 
			nargs=3, default=(15000, 3, 5), type=int)
    parser.add_argument('-rt', '--rt', help="right top (freq, onsteps, allsteps)", 
			nargs=3, default=(1000,  15, 55), type=int)
    parser.add_argument('-rd', '--rd', help="left down (freq, onsteps, allsteps)", 
			nargs=3, default=(15000, 15, 55), type=int)
